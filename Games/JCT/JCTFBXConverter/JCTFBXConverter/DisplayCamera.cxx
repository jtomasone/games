...
void JCTFBXConvert::DisplayCamera(KFbxNode* pNode)
{
    DisplayCamera((KFbxCamera*) pNode->GetNodeAttribute(), (char *) pNode->GetName(), pNode->GetTarget(), pNode->GetTargetUp());
}


void JCTFBXConvert::DisplayCamera(KFbxCamera* pCamera, char* pName, KFbxNode* pTargetNode, KFbxNode* pTargetUpNode)
{
...
void JCTFBXConvert::DisplayCameraPositionAndOrientation(KFbxCamera* pCamera, KFbxNode* pTargetNode, KFbxNode* pTargetUpNode)
{
...
void JCTFBXConvert::DisplayViewingAreaControls(KFbxCamera* pCamera)
{
...
void JCTFBXConvert::DisplayApertureAndFilmControls(KFbxCamera* pCamera)
{
...
void JCTFBXConvert::DisplayBackgroundProperties(KFbxCamera* pCamera)
{
...
void JCTFBXConvert::DisplayCameraViewOptions(KFbxCamera* pCamera)
{
...
void JCTFBXConvert::DisplayRenderOptions(KFbxCamera* pCamera)
{
...
void JCTFBXConvert::DisplayDefaultAnimationValues(KFbxCamera* pCamera)
{
